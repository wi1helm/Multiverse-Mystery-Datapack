...
scoreboard players remove @e[tag=wild_rabbits_package_procent] wild_rabbits_package_procent 25
execute store result storage minecraft:quests package.wild_rabbits.temp.procent float 0.1 run scoreboard players get @e[tag=wild_rabbits_package_procent,limit=1] wild_rabbits_package_procent
