...
execute if score @s hopHooverRange matches ..20 if block ~ ~ ~ air positioned ~ ~-1.35 ~ positioned ^ ^ ^0.1 positioned ~ ~1.35 ~ run function general:quests/spaceship/items/hop-hoover/raycast
