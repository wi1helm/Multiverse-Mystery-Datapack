...
execute store result storage minecraft:entity rabbit.vector.temp.vx float 0.001 run scoreboard players get xRabbitPos hopHooverVectors
execute store result storage minecraft:entity rabbit.vector.temp.vy float 0.001 run scoreboard players get yRabbitPos hopHooverVectors
execute store result storage minecraft:entity rabbit.vector.temp.vz float 0.001 run scoreboard players get zRabbitPos hopHooverVectors
