...
execute as @s run function general:players/scoreboards/utils/scoreboard_set with storage minecraft:player shards.temp
#Update API
...
execute as @s run function general:players/player_systems/shards/utils/update_shards_set with storage api:player temp
# Remove temp files
