...
# Loop all teams
execute as @s run function general:utils/loop/for_each_function {"function":"general:players/player_systems/teams/assign","list_path":"player team.teams","varible":"team"}
