...
execute as @s run function general:utils/players/get_name {"path":"minecraft:player objectives.temp.name"}
...
function general:players/bossbar/objectives/utils/objective_api_save
