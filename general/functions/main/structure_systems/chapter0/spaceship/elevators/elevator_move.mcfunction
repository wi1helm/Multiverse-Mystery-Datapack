...
$execute as @e[tag=spaceship_elevator_$(type),tag=spaceship_elevator_move] if score @s spaceship_elevator_switch matches 1 if score @s spaceship_elevator_pos matches ..-62510 run return run function general:main/structure_systems/chapter0/spaceship/elevators/utils/return_elevator
